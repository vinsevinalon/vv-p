...
function App() {
    return (
        <>
            <SkyBackground />
            <div className="min-h-screen text-[#1A1A1A] font-sans p-2 md:p-8">
                <div className="max-w-6xl mx-auto border-[3px] md:border-[4px] border-[#1A1A1A] min-h-[calc(100vh-1rem)] md:min-h-[calc(100vh-4rem)] flex flex-col shadow-[4px_4px_0px_0px_rgba(26,26,26,1)] md:shadow-[8px_8px_0px_0px_rgba(26,26,26,1)]">
                    ...
                    <main className="flex-grow flex flex-col">
                        ...
                        <section className="border-t-[3px] md:border-t-[4px] border-[#1A1A1A] p-6 md:p-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 text-xs md:text-sm font-mono">
                                <div className="p-4 border-[2px] border-white space-y-1 md:space-y-2 ">
                    ...
                    <footer className="border-t-[3px] md:border-t-[4px] border-[#1A1A1A] p-4 md:p-6 flex flex-col md:flex-row justify-between items-center text-[8px] md:text-[10px] uppercase font-mono tracking-widest gap-4 md:gap-0">
